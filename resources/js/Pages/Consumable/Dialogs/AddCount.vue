    ...
    <div>        
        <form @submit.prevent="save">            
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    <Label for="count_stock">{{ labelsConsumable?.description }}</Label>
        ...
        <div class="mt-2 pt-2 border-t border-gray-300 flex justify-between font-bold">
            ...
            <loading-button :loading="form.processing" type="button" @click="save">Добавить</loading-button>
        </div>
    </div>
</template>